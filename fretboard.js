...
(function ($) {
    ...
    var Fretboard = function ($fretboardContainer, settings) {
        ...
        var setClickedNoteByStringNoteAndFretNum = function (stringLetter, stringOctave, fretNumber, params) {
            for (var i = 0; i < guitarStringNotes.length; i++) {
        ...
        // to be used internally
        var setClickedNoteByStringNumAndFretNum = function (stringNum, fretNum, params) {
        ...
        var placeNoteOnFretboardByStringNoteAndFretNum = function (stringLetter, stringOctave, fretNumber, params) {
        ...
        var placeNoteOnFretboardByStringNumAndFretNum = function (stringNumber, fretNumber, params) {
        ...
        var placeNote = function (group, stringNumber, fretNumber, params) {
            var circ = group[0];
            var text = group[1];
